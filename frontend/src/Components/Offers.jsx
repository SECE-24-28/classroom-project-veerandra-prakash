...
const Offers = () => {
  ...
  const categories = [
    ...
    { id: 'mobile', name: 'Mobile', count: offers.filter(o => o.category === 'mobile').length },
    { id: 'dth', name: 'DTH', count: offers.filter(o => o.category === 'dth').length },
    { id: 'bills', name: 'Bills', count: offers.filter(o => o.category === 'bills').length }
  ];
